...
> **📝 Personal Note** — I'm using this fork primarily with the Gemini model. If you're doing the same, make sure to set `GEMINI_API_KEY` in your `.env` file. The default model config worked well for me out of the box.
